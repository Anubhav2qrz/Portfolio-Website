  ...
  return (
    <section id="contact" className="py-20 bg-background relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-20 w-40 h-40 bg-accent/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          <div className="space-y-8">
            <div className="animate-fade-in-up">
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                I'm always excited to connect with fellow data enthusiasts, potential clients, 
                and anyone interested in the intersection of analytics and design. Whether you 
                have a project in mind or just want to network, feel free to reach out!
              </p>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`w-12 h-12 bg-gradient-to-br ${info.gradient} rounded-xl flex items-center justify-center mr-4 flex-shrink-0`}>
                        <Icon className="w-6 h-6 text-background" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <h4 className="font-medium text-card-foreground">{info.label}</h4>
                        {info.href ? (
                          <a 
                            href={info.href}
            ...
            {/* Resume Download */}
            <Card className="p-6 bg-gradient-card border border-border/50 backdrop-blur-sm hover:shadow-card transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-medium text-card-foreground mb-1">Download Resume</h4>
                  <p className="text-sm text-muted-foreground">Get a detailed overview of my skills and experience</p>
                </div>
                <Button 
                  variant="outline"
                  size="sm"
